...
SerialPort::SerialPort() {
	...
	LpcPinMap txpin = { 1, 9 }; // transmit pin that goes to debugger's UART->USB converter
	LpcPinMap rxpin = { 1, 10 }; // receive pin that goes to debugger's UART->USB converter
	LpcPinMap rtspin = { 0, 29 }; // receive pin that goes to debugger's UART->USB converter
